...
{
    public class ShortMeleeHandling : GunHandlingSkill
    {
        //TODO Переопределить все для рукопашного оружия
        ...
        public ShortMeleeHandling(int currentLevel = 1) : base(currentLevel)
        {
        }
    }
}